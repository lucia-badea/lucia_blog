        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="post-heading">
                    ...
                    <span class="meta">
                        <p>Posté par <?= htmlspecialchars($article->getEditor()); ?> Le : <?= htmlspecialchars($article->getUpdated_at()); ?> </p>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="container px-4 px-lg-5">
            ...
            if (empty($comments)) {
                ...
                ?>
                    ...
                    <p class="font-weight-light">Commenté par : <?= htmlspecialchars($comment->getAuthorComment()); ?></p>
                <?php
                }
